package com.example.gridlayoutcards
...
import com.example.gridlayoutcards.adapters.AlphaAdapters
import com.example.gridlayoutcards.model.CharItem
...
class MainActivity : AppCompatActivity() {
    ...
    private fun setAlphas(): ArrayList<CharItem> {
        ...
        arrayList.add(CharItem(R.drawable.download_7, "wall 6"))
        arrayList.add(CharItem(R.drawable.download_8, "wall 7"))
        arrayList.add(CharItem(R.drawable.download_9, "wall 8"))
        ...
        arrayList.add(CharItem(R.drawable.download_7, "wall 14"))
        arrayList.add(CharItem(R.drawable.download_8, "wall 15"))
        arrayList.add(CharItem(R.drawable.download_9, "wall 16"))
        ...
        arrayList.add(CharItem(R.drawable.download_9, "wall 24"))
        return arrayList
